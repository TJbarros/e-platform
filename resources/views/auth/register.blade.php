                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('bibliography') ? ' has-error' : '' }}">
                            <label for="bibliography" class="col-md-4 control-label">Bibliografia</label>

                            <div class="col-md-6">
                                <textarea id="bibliography" name="bibliography" class="form-control">{{ old('bibliography') }}</textarea>
